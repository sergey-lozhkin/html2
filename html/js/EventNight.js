Elm.EventNight = Elm.EventNight || {};
Elm.EventNight.make = function (_elm) {
   "use strict";
   _elm.EventNight = _elm.EventNight || {};
   if (_elm.EventNight.values)
   return _elm.EventNight.values;
   var _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _E = _N.Error.make(_elm),
   _J = _N.JavaScript.make(_elm),
   $moduleName = "EventNight";
   var Ark = Ark || {};
      ...
      return function () {
         ...
         _J.toList([A3(Graphics.Element.fittedImage,
                   ...
                   _J.toList([Text.leftAligned(Ark.Parameters.showNormalText("Ирина БРОДСКАЯ"))
                             ...
                             ,Text.leftAligned(Ark.Parameters.showNormalText("Марк СТАРОСЕЛЬСКИЙ"))])))]));
         var pictureBuy = A2(Graphics.Element.flow,
         Graphics.Element.down,
         _J.toList([A3(Graphics.Element.fittedImage,
                   p1w,
                   p1h,
                   "assets/details-last-night.jpg")
                   ,A2(Graphics.Element.spacer,
                   s1s,
                   s1s)
                   ,Graphics.Element.width(d2w)(Text.centered(Ark.Parameters.showCityText("SAN FRANCISCO")))
                   ,Graphics.Element.width(d2w)(Text.centered(Ark.Parameters.showDateText("26 апреля 7pm")))
                   ,Graphics.Element.width(d2w)(Text.centered(Ark.Utils.ulink("http://www.russiancentersf.com/contact")(Ark.Parameters.showPlaceText("Russian Center of San Francisco"))))
   ...
   skeleton,
   Window.width);
   _elm.EventNight.values = {_op: _op
                            ,main: main
                            ,skeleton: skeleton
                            ,sidebar: sidebar
                            ,content: content};
