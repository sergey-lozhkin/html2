Elm.EventSummerDay = Elm.EventSummerDay || {};
Elm.EventSummerDay.make = function (_elm) {
   "use strict";
   _elm.EventSummerDay = _elm.EventSummerDay || {};
   if (_elm.EventSummerDay.values)
   return _elm.EventSummerDay.values;
   var _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _E = _N.Error.make(_elm),
   _J = _N.JavaScript.make(_elm),
   $moduleName = "EventSummerDay";
   var Ark = Ark || {};
   ...
   skeleton,
   Window.width);
   _elm.EventSummerDay.values = {_op: _op
                                ,main: main
                                ,skeleton: skeleton
                                ,sidebar: sidebar
                                ,content: content};
