...
activitiesHistory = do
  ...
  html_ [lang_ "en"] $ do
    head_ $ do
      ...
      link_ [rel_ "stylesheet", href_ "css/fonts.css", type_ "text/css", charset_ "utf-8"]
      link_ [rel_ "stylesheet", href_ "css/bootstrap.min.css", type_ "text/css", charset_ "utf-8"]
